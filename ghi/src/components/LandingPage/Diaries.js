...
export default function DiariesInfo({back}) {
    ...
    return (
        <div className="diary-features" style={{ fontFamily: "Short Stack, cursive"}}>
            <button style={{ fontFamily: "Short Stack, cursive"}}
            onClick={back}>back</button>
            <h1>Create Personal Diaries</h1>
            <p style={{ fontSize: '20px' }}>the journal feature empowers users to engage in self-reflection, self-expression, and self-monitoring.
