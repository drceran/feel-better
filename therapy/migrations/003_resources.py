steps = [
    [
        ...
        CREATE OR REPLACE FUNCTION check_writer_is_therapist()
        RETURNS TRIGGER AS $$
        BEGIN
...
# $$ is a string literal and we need string literals
#  to be able to filter through data
# after filtering we need to tell the
# PostgreSQL engine know what language to
# interpret the data in
# we create a trigger to check if the writer
# is a client or therapist before we can insert or update resources
